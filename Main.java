...
/*public class student{
 ...
 class Main {
    public static void main(String[] args) {
        ...
        System.out.println("[1] for Christ university");
        System.out.println("[2] for Amity University");
        System.out.print("Enter your choice => ");
        Scanner ch = new Scanner(System.in);
        int choice = ch.nextInt();
        if (choice == 1) {
            System.out.println("**********WELCOME TO CHRIST (DEEMED TO BE UNIVERSITY)**********");
            ...
            System.out.println("**********WELCOME TO AMITY UNIVERSITY**********");
            ami obj1 = new ami();
            obj1.insertStudents();
            obj1.exam();
            obj1.result();
